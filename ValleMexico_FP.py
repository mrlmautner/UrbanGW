...
# Load datasets
ACTIVE = gen.openASC('data_output\ACTIVE.asc')
...
# COL2 : Phase well pumping multiplier
...
#mm = flopy.plot.ModelMap(model=mf,layer=1)
#mm.plot_array(h,masked_values=[-888,-999])
#mm.plot_inactive()
#mm.plot_bc(ftype='STR')
#plt.show()
...
#plt.savefig('Tlalpan1a.png')
#
#plt.show

#flopy.plot.crosssection.ModelCrossSection(model=mf, dis=dis, line={'row':55}, xul=xll, yul=yur, rotation=5)