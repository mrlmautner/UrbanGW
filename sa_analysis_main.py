...
#sa_dataset.cluster_kde(threshold=0.05)
...
#sa_dataset.objective_scatter(params=['HK_1'], threshold=0.05, show_all=True)
#sa_dataset.error_scatter(params=['HK_4'], threshold=0.05, show_all=True)
#sa_dataset.objective_scatter(params=['HK_5'], threshold=0.05, show_all=True)
#sa_dataset.error_scatter(params=['HK_4','TWU_1','RCH_2'], threshold=0.05, show_all=True)
#sa_dataset.historical_scatter(params=['HK_4'], threshold=0.05, show_all=True)
...
#sa_dataset.param_sensitivity(sens_type='delta', threshold='0.05', constant='Historical')
#sa_dataset.param_sensitivity(sens_type='delta', threshold='0.93836', constant='Historical',  def_params=['HK_2','HK_3','HK_4','IN_1','RCH_2','TWU_1','TWU_2','TWU_3'])
#sa_dataset.param_sensitivity(sens_type='delta', threshold='0.05', constant='Historical',  def_params=['HK_2','HK_3','HK_4','IN_1','RCH_2','TWU_1','TWU_2','TWU_3'])
#ranked_df_melt, ranked_df_table, ranked_df_normalized = sa_dataset.heatmap_by_param(params=['HK_5'], threshold=0.05, n_samples=100000, c='C-00005')
